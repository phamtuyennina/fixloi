...
if(! defined('WAIT_BETWEEN_FETCH_ERRORS') )	define ('WAIT_BETWEEN_FETCH_ERRORS', 36000);				// Time to wait between errors fetching remote file
...
if(! defined('MAX_WIDTH') )					define ('MAX_WIDTH', 9500);								// Maximum image width
if(! defined('MAX_HEIGHT') )				define ('MAX_HEIGHT', 9500);							// Maximum image height
