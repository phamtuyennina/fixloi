...
@define ('_donhangcuabanchuaduocgui','Đơn hàng của bạn chưa được gửi');
@define ('_vuilongdiendayduthongtinlai','Vui lòng điền đầy đủ thông tin lại');
@define ('_camon','Cảm ơn');
@define ('_bandadathangthanhcong','Bạn đã đặt hàng thành công');
@define ('_chungtoiselienhesomnhat','Chúng tôi sẽ liên hệ với bạn sớm nhất');
@define ('_madonhangla','Mã đơn hàng là');
@define ('_donhangcuabanchuacosanpham','Đơn hàng của bạn chưa có sản phẩm');
@define ('_vuilongchonsanphamdedathang','Vui lòng chọn sản phẩm để đặt hàng');
@define ('_xinloiquykhach','Xin lỗi quý khách');
@define ('_hethongbiloixinquykhachthulai','Hệ thống bị lỗi, xin quý khách thử lại');
@define ('_banchuamuasanphamnaovuilongchonmua','Bạn chưa mua sản phẩm nào.Vui lòng chọn mua sản phẩm');
@define ('_banchacchanmuonxoasanphamnay','Bạn chắc chắn muốn xóa sản phẩm này !!');
@define ('_bancomuonxoahetsanpham','Bạn chắc chắn muốn xóa hết sản phẩm trong giỏ hàng !!');
